...
namespace WarehouseManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260331160854_projecttAgainUpdated")]
    partial class projecttAgainUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Domain.Model.Transfer", b =>
                {
                    b.HasOne("WarehouseManagementSystem.Domain.Model.Transfer", null)
                        .WithMany()
                        .HasForeignKey("FromLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WarehouseManagementSystem.Domain.Model.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
